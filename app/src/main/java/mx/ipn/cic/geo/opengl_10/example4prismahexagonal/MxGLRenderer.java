...
public class MxGLRenderer implements Renderer {
	...
	/** Pyramid instance */
	private MxGLPyramid pyramid;
	/** Cube instance */
	//private MxGLCube cube;
	...
	public void onDrawFrame(GL10 gl) {
		...
		gl.glTranslatef(0.0f, 0.0f, -7.0f);		//Move up 1.3 Units and -6.0 as the origin matrix is loaded before
		gl.glRotatef(rtri, 1.0f, 0.0f, 0.0f);	//Rotate The Triangle On The Y axis
